...
st.markdown("""
    ...
    /* ★ 모바일에서 상자가 튀어나가는 현상 완벽 방어 (Grid 적용) ★ */
    @media (max-width: 768px) {
        div[data-testid="stHorizontalBlock"] {
            display: grid !important;
            grid-auto-flow: column !important; /* 무조건 한 줄에 가로로 배치 */
            grid-auto-columns: 1fr !important; /* 상자가 몇 개든 크기를 똑같이(1:1) 강제 분할 */
            gap: 12px !important; /* 상자 사이 여백 */
            width: 100% !important; /* 화면을 절대 넘지 않음 */
        }
        div[data-testid="column"],
        div[data-testid="stColumn"] {
            width: 100% !important;
            min-width: 0 !important; /* 내용물이 길어도 상자 밖으로 안 튀어나가게 잘라줌 */
            margin: 0 !important;
        }
    }
    </style>
